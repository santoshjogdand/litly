...
function Dashboard() {
  ...
  return (
    <div className='text-black h-full md:w-[70%] flex justify-center items-center'>
      <div className="container md:h-[30rem] h-[100dvh] w-full md:rounded-lg bg-white p-8 flex flex-col justify-center md:mx-8 gap-6">
        ...
        <div className="section3 flex flex-col gap-4">
          ...
          <div className="section2 flex md:flex-row flex-col gap-2 items-center w-full text-sm font-medium  text-gray-700">
            ...
            <div className="customLink flex flex-col gap-1 w-full">
              ...
              <input type="text" placeholder='your custom backhalf' className='border-1 rounded-lg h-10 p-4 w-full' id="customLink" />
            </div>

          </div>

          <div className="buttons flex flex-col md:flex-row gap-2 justify-center">
            <DashboardButton buttonTXT={`Create Random Shortlink`} className={`text-sm cursor-pointer inset-shadow-sm inset-shadow-white active:bg-purple-600 text-white bg-purple-500 px-3 rounded-lg h-10 shadow-md shadow-purple-500 border border-white`} />
            <DashboardButton buttonTXT={`Create Custom Shortlink`} className={`text-sm cursor-pointer inset-shadow-sm inset-shadow-white active:bg-purple-600 text-white bg-purple-500 px-3 rounded-lg h-10 shadow-md shadow-purple-500 border border-white`} />
          </div>
        </div>
