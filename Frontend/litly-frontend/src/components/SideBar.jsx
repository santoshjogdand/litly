...
const SideBar = ({ status, setStatus }) => {
    ...
    return (
        <nav id="side-nav" className={`h-[100dvh] bg-white fixed flex z-40 flex-col transition-all duration-300 ease-in-out ${status ? 'w-60' : 'md:w-20 md:left-0 left-[-20rem]'}`} >
